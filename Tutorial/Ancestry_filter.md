...
#### The Ancestry_filter is an option to select the predicted ancestry you wish to filter on. 
...
#### This only works with one ancestry at a time. If Ancestry_var option is not set when using this option, the automatic default is a min ancestry percentage of 75%. 

This is part of the <b> cohortSelection.R </b> script.
